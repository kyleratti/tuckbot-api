...
router.get('/mobilitymary', (req, res) => {
    return res.status(http_status_codes_1.default.OK).render('mobilitymary', {
        ...
        posts: [
            ...
            { redditPostId: "8zzmb1", title: "Mobility Mary almost dies" },
            { redditPostId: "901sf3", title: "Mobility Mary cries when homeless encampment blocks her path." },
            { redditPostId: "8zy3kg", title: "Mobility Mary freaks out on guy blocking the handicap ramp" },
            { redditPostId: "901doq", title: "Mobility Mary has an encounter with a cyclist blocking the crosswalk" },
            { redditPostId: "8zy5q1", title: "FREEWAY ONRAMP 3 CARS CUT ME OFF (Mobility Mary)" },
            { redditPostId: "906exg", title: "Mobility Mary suffers abuse at the hands of Scooter thugs" },
            { redditPostId: "8zwjwe", title: "Mobility Mary almost gets cut off by a MANIAC in the crosswalk - UNBELIEVABLE" },
            { redditPostId: "90g6up", title: "Mobility Mary teams up with Random Old Lady to fight bad drivers!" },
            { redditPostId: "90e29s", title: "Mobility Marry: \"People hit me all the time\"" }
        ]
    });
});
